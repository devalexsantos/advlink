...
export default function Preview02({ profile, areas, address, links = [], gallery = [], sectionOrder, sectionLabels, customSections = [], sectionIcons, sectionTitleHidden, teamMembers = [] }: Props) {
