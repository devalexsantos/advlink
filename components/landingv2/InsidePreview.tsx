    ...
    <section className="relative py-12 px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
        <motion.h2
          ...
          className="text-center text-3xl md:text-5xl font-extrabold tracking-tight mb-4 text-zinc-900"
        >
        ...
        <motion.div
          ...
          className="rounded-2xl border border-zinc-200 bg-white p-4 overflow-hidden"
        >
