      ...
      <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <motion.h2
            ...
            className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-zinc-900"
          >
          ...
          <div className="space-y-3">
            {steps.map((s, idx) => {
              ...
              return (
                ...
                >
                  <div className={`rounded-md p-2 mt-0.5 border ${isActive ? "border-amber-300 bg-white" : "border-zinc-200 bg-white"}`}>
                    <Icon className="w-5 h-5 text-zinc-700" />
                  </div>
                  <div>
                    <h3 className={`font-semibold ${isActive ? "text-zinc-900" : "text-zinc-800"}`}>{s.title}</h3>
          ...
          <div className="relative w-full max-w-xl overflow-hidden rounded-2xl">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute inset-0 grid place-items-center rounded-2xl border border-zinc-200 bg-white"
              >
