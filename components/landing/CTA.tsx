    ...
    <section className="relative mx-auto max-w-6xl px-6 pb-8">
      <div className="relative overflow-hidden rounded-2xl border border-zinc-700 bg-gradient-to-r from-zinc-900 to-black p-8 md:p-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_10px_40px_-20px_rgba(255,255,255,0.08)]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <Link href="/onboarding" className="mt-6 inline-flex items-center gap-2 rounded-full border border-amber-400 bg-gradient-to-b from-amber-500 to-amber-700 px-6 py-3 text-white font-bold [text-shadow:0_1px_0_rgba(0,0,0,0.35),0_2px_8px_rgba(0,0,0,0.25)] hover:from-amber-400 hover:to-amber-600 transition text-xl">
            Testar grátis
