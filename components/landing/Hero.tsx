...
import mockup from "/public/images/advlink-mockup-iphone-white.png"
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 items-center">
          ...
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <Image src={whiteLogo} alt="Logo" width={120} height={120} className="w-30 h-30" />
            </div>
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight bg-gradient-to-r from-zinc-50 via-zinc-300 to-zinc-400 bg-clip-text text-transparent [text-shadow:0_1px_0_#fff,0_2px_10px_rgba(255,255,255,0.12)]">
            ...
            <div className="flex flex-col gap-4 justify-center md:justify-start items-center md:items-start mt-4 max-w-2xl text-zinc-300/90 text-lg">
              <h3 className="text-center md:text-left text-xl">
          ...
          {/* Right: imagem de exemplo */}
          <div className="relative w-full flex justify-center">
            <div className="relative">
              <Image src={mockup} alt="Exemplo de uso" width={520} height={520} className="w-full max-w-md h-auto" />
              <div className="pointer-events-none absolute inset-0 -z-10 blur-3xl rounded-full bg-amber-400/20" />
            </div>
          </div>
        </div>
      </div>
